...
{
    public static final int UPCOLLECTERLIMIT = 180;
    public static final int LOWCOLLECTERLIMIT = 0;
    public static final double COLLECTINITIALDEGREE = 0;
    public static final int XCONTROLLERP = 0;
    public static final int YCONTROLLERP = 0;
    public static final int THETACONTROLLERP = 0;
    public static final boolean THETACONSTRAINTS = false;
    public static final double MAXVELOCITY = 0;
    public static final double MAXANGULAR = 0;
